...
emissions (Gagnon, Ricks, Jenkins et al.\ 2022); marginal factors have not fallen
...
procurement should therefore report the accounting choice explicitly and prefer
regions robust across the multiverse. \S5.1 makes this actionable.
...
\bibitem{gagnon2022}
Gagnon, P., Ricks, W., Jenkins, J.\ D., et al.\ (2022).
Minimizing emissions from grid-based electricity consumption.
\textit{PNAS} (Ricks, Xu \& Jenkins).
...
\bibitem{lme2024}
LME validation (2024).
\textit{Environmental Research: Energy}.
